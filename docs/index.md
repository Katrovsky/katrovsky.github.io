...
Перед началом смены надо пройти фотоконтроль: прислать свою фотографию в соответствующий канал (в некоторых городах фотография должна быть отправлена боту, в таком случае требования по фотографии будут описаны в сообщении от бота), требования к фотографии следующие:

 1. Фотография должна быть сделана перед отправкой, не заранее или позднее.
 2. На фотографии должно быть ясно видно, что это вы и на вас надета форма компании.
 3. Не следует отправлять фотографии повторно.

Теперь следует начать смену. В приложении следует пройти диагностику, и смена будет начата.
