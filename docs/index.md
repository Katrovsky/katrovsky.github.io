...
![sample](index/dress-code.png){ width="100%" align=right loading=lazy }
</div>
...
* Перед каждой сменой мы обязаны делать фотографию для фотоконтроля. Стандарт следующий (если вы не получали сообщений, указывающих иное):
  *  
