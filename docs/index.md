...
В начале смены необходимо быть опрятным, бренд компании на форменной одежде должен быть виден. Наличие рюкзака не отменяет необходимость ношения формы. В целом, внешний вид должен с любого ракурса сообщать о том, что вы курьер Сбермаркета. { .md-button } ![sample](index/dress-code.png){ width="auto" align=right loading=lazy }
</div>
